...
object Device {
  type DeviceId = Id @@ Device // cannot be used whenever tapir is used due to problem during macros expansion which cannot find appropriate decoder/encoder automatically when type alias used
}
